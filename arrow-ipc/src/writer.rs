...
impl IpcDataGenerator {
    ...
    pub fn schema_to_bytes_with_dictionary_tracker(
        ...
        let schema = {
            let fb = IpcSchemaEncoder::new(dictionary_tracker)
...
impl DictionaryTracker {
    ...
    /// This will return the value of the last `dict_id` assigned incremented by 1 or 0 in the case
    /// where no dictionary IDs have yet been assigned.
...
impl<W: Write> FileWriter<W> {
    ...
    pub fn finish(&mut self) -> Result<(), ArrowError> {
        ...
        let mut dictionary_tracker =
            DictionaryTracker::new(true);
        let schema = IpcSchemaEncoder::new(&mut dictionary_tracker)
...
mod tests {
    ...
    fn track_union_nested_dict() {
        ...
        gen.schema_to_bytes_with_dictionary_tracker(&schema, &mut dict_tracker, &Default::default());
    ...
    fn track_struct_nested_dict() {
        ...
        // We explicitly expect the dict ID to be 0 here, because the encoder will assign dict IDs itself.
        assert!(dict_tracker.written.contains_key(&0));
    }
